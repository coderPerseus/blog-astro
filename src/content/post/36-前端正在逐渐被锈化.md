...
tags: ["前端基建","学习笔记"]
description: "jeff Atwood 在 2007 年说：\"any application that can be writen in JavaScript , willeventually be written in JavaScript\"，翻译过来就是：“任何可以使用 JavaScript 来编写的应用，并最终也会由 JavaS"
---
