...
tags: ["部署","CI/CD"]
description: "由于部署在服务器一个静态 blog：https://mp.weixin.qq.com/s/tBxfcDsMIh_HCRS1EqBMoQ ，希望源码变更就会自动重新部署，下面一起来实现一下\r\n\r\n 需求\r\n\r\n我项目源码是在 github，通过 github issues 来存储 blog ，通过 github acti"
---
