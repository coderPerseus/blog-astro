...
description: "Vercel 团队最近的一篇博客分享了如何让 Agent 使用 Next.js 正确的 API，实现根据当前项目安装的 Next.js 版本使用正确的 API ，而不是使用非当前版本的 API 。如果你是 Next.js 开发者，你肯定知道这是非常重要的，因为 Next.js 的版本更新非常的快速。\n\n最有趣的是 Ve"
---
