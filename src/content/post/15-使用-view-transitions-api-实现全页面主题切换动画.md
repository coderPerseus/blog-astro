...
tags: ["动画","翻译","React"]
description: "这是一篇译文，原文：https://akashhamirwasia.com/blog/fullpagethemetoggleanimationwithviewtransitionsapi\r\n\r\nTelegram 应用程序在其暗黑模式切换时有一个非常有趣的动画效果,暗色主题从开关处扩展覆盖整个应用程序。我一直想知道这在底"
---
