...
tags: ["闲聊","程序人生"]
description: "Hi everyone, I'm luckySnail. I checked the calendar today and realized it is already June. Half of 2025 is gone. That jolted me into reviewing the goals I set at the beginning of the year. I am still moving along the path I planned, even though I get anxious, slack off, and feel down sometimes. I have not given up, and I am grateful to myself for staying with it over the past six months. Years from now, I think 2025 will still feel unforgettable. Here are my experiences from the first half of the year."
---

![Recent Life](https://blog-1304565468.cos.ap-shanghai.myqcloud.com/typora/%E8%BF%91%E6%9C%9F%E7%94%9F%E6%B4%BB.webp)

Hi everyone, I'm luckySnail. Today I glanced at the calendar and realized it is already June. Half of 2025 is gone. That scared me into checking the goals I set at the beginning of the year, and I feel like I am still moving along the path I planned. I get anxious, slack off, and feel down sometimes, but I have not given up. I am grateful to myself for staying with it over the past half year. Years from now, I think 2025 will still feel unforgettable. Here are my experiences and reflections from these six months. I hope they help you too.
...
In the past six months, after some reflection, I left the company I'd worked at for two years and joined a new company building AI products. Under the impact of AI, I systematically learned Node.js and its upper-layer framework Nest.js, and through practice I developed a full-stack project: [SVG Show](https://www.svgshow.cn/) (a tool site for creating beautiful images with SVG). I also tried marketing through self-media and open-source communities, achieving my first product with 1K+ users. Aside from doing self-media for the product, I also actively shared some observations and thoughts about my work and life. The main platforms I maintain are WeChat Official Account and Xiaohongshu (Little Red Book); occasionally I also post on Douyin and Bilibili. In the past six months, AI has permeated almost every part of my daily life, from coding at work to content creation and everyday search. Lately I've even been trying to develop my first browser extension using vibe coding. Oh, and during these six months I also spent a lot of time writing resumes, submitting them, optimizing them, and going through interviews. Those things were tough for me.
...
I listened to Liang Bo's fourth album *Spirit* (精气神), and I love the lyrics in "Escape the World" (避世离俗): "Child, if someone says you are lonely, don't hesitate. Go your own way, be your own master."
...
I read new books: technical ones such as *A Philosophy of Software Design, Second Edition* and *You Don't Know JS* (Up & Going, Scope & Closures), plus a mindset book, *Do Hard Things That Are Right*.

I exercised a few times. The benefits of working out are obvious, but something always gets in the way. Just kidding, I need to stop making excuses.

I played several seasons of Teamfight Tactics (Golden Spatula) and reached Master every season. Lately I've been watching the Korean drama *When Life Gives You Tangerines* (苦尽甘来遇见你). It is really good. What keeps you afloat in life?
...
- **ChatHub**: Free unlimited annual membership from my company, supports all major LLMs, and is genuinely useful.
...
If you have any other useful AI tools that boost your productivity, feel free to share them.
...
1. Ruan Yifeng's technical resume guide: https://ruanyifeng.com/blog/2020/01/technical-resume.html
2. CodeFather's resume course: https://www.codefather.cn/course/cv
